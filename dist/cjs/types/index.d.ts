...
export type SchemaType = 'string' | 'number' | 'object' | 'collection' | 'array' | 'boolean' | 'currency' | 'percent' | 'date';
...
export type CurrencyValidSchemaField = NumberSchemaField | CommonValidSchemaField;
