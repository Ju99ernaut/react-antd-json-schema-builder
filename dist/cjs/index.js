...
var noop$1 = require('lodash/noop');
...
var set$1 = require('lodash/fp/set');
...
var set__default = /*#__PURE__*/_interopDefaultLegacy(set$1);
...
var useUnsavedChanges = function (data) {
    var _a = React$1.useState(false), isDirty = _a[0], setDirty = _a[1];
    var isFirstRender = React$1.useRef(true);
...
var g=React__default["default"];function n(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}var p="function"===typeof Object.is?Object.is:n,q=g.useSyncExternalStore,r=g.useRef,t=g.useEffect,u=g.useMemo,v=g.useDebugValue;
...
var SchemaProvider = function (_a) {
    ...
    var _b = React$1.useState([]), changes = _b[0], setChanges = _b[1];
...
var useSchemaContext = function () { return React$1.useContext(SchemaContext); };
...
var useDecodeSchema = function (schema) {
    var schemaType = React$1.useMemo(function () { return getSchemaType(schema); }, [schema]);
    var schemaTitle = React$1.useMemo(function () { return getSchemaTitle(schema); }, [schema]);
    var schemaProperties = React$1.useMemo(function () { return getSchemaProperties(schema); }, [schema]);
    return {
...
var useControls = function (_a) {
    ...
    var _d = React$1.useState(rootNode || autoExpand), show = _d[0], setShow = _d[1];
    var _e = React$1.useState(false), showModal = _e[0], setShowModal = _e[1];
...
var SchemaOptions = function (_a) {
    ...
    var type = getSchemaType(schema);
    var allOptions = React$1.useMemo(function () { return getSchemaMenuOptions(type); }, [type]);
...
var CommonControls = function (_a) {
    ...
    var _c = React$1.useState(false), hover = _c[0], setHover = _c[1];
...
var SchemaBuilder$1 = function (_a) {
    ...
    return (React__default["default"].createElement(SchemaProvider, null,
        ...
        React__default["default"].createElement(antd.Row, { align: "middle", style: { padding: '16px' } },
            React__default["default"].createElement(antd.Col, { xs: 10, xl: 11 },
                React__default["default"].createElement(antd.Row, { justify: "space-around", align: "middle" },
                    React__default["default"].createElement(antd.Col, { span: 2 }),
                    React__default["default"].createElement(antd.Col, { span: 22 }, "Name"))),
            React__default["default"].createElement(antd.Col, { xs: 10, xl: 11 }, "Type"),
            React__default["default"].createElement(antd.Col, { xs: 2, xl: 1 }),
            React__default["default"].createElement(antd.Col, { xs: 2, xl: 1 })),
        React__default["default"].createElement(SchemaCreator, { schema: schemaInRedux.present.schema, onChange: function (schema) {
                onChange(schema);
...
var UndoRedoUI = function (_a) {
    ...
    return (React__default["default"].createElement(antd.Space, { id: "schema-state-control" },
        React__default["default"].createElement(antd.Tooltip, { title: "Undo" },
            React__default["default"].createElement(antd.Button, { title: "Undo", icon: React__default["default"].createElement(icons.UndoOutlined, null), onClick: onUndo, disabled: !canUndo })),
        React__default["default"].createElement(antd.Tooltip, { title: "Redo" },
            React__default["default"].createElement(antd.Button, { title: "Redo", icon: React__default["default"].createElement(icons.RedoOutlined, null), onClick: onRedo, disabled: !canRedo }))));
};
...
var SchemaBuilder = function (_a) {
    var data = _a.data, onChange = _a.onChange;
    return (React__default["default"].createElement(Provider_default, { store: store },
        React__default["default"].createElement(UndoRedo, null),
        React__default["default"].createElement(SchemaBuilder$1, { data: data, onChange: onChange })));
};
